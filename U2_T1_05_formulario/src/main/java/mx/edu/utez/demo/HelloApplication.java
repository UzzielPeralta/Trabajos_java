...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        grid.setStyle("-fx-background-color: #087c08;");
        lblResultado.setStyle("-fx-text-fill: #27d7d7;");
        ...
        btnCrear.setOnAction( e -> {
            if (tfNombre.getText().isEmpty() || tfApellido.getText().isEmpty() || tfEdad.getText().isEmpty()) {
               ...
               lblResultado.setText("Nombre: " + tfNombre.getText() + " Apellido: " + tfApellido.getText() + " Edad: " + tfEdad.getText() + " Rol: " + cbRol.getValue());
        }
                }
        );
